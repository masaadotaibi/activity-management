...
class TasksController extends GetxController {
  ...
  Rx<List<TaskModel>> tasksList = Rx<List<TaskModel>>();

  // 27 we need to stream the list of tasks to the personal folder
  List<TaskModel> get tasks => tasksList.value;
  ...
  void onInit() {
    ...
    tasksList.bindStream(PersonalFolderCollection().personalTasksStream(uid));
